...
Date : ${startDateTime.toLocaleDateString('fr-FR', { weekday: 'long', day: 'numeric', month: 'long', year: 'numeric' })}
Heure : ${startDateTime.toLocaleTimeString('fr-FR', { hour: '2-digit', minute: '2-digit' })} - ${endDateTime.toLocaleTimeString('fr-FR', { hour: '2-digit', minute: '2-digit' })} (UTC+1)
